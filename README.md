...
uv run --with pytest --with pytest-asyncio python -m pytest tests/ -q 2>&1 | tail -3 && git add -A && git commit -m "Release v1.3.6" && git tag v1.3.6 && git push origin main --tags
```
