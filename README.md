...
uv run --with pytest --with pytest-asyncio python -m pytest tests/ -q 2>&1 | tail -3 && git add -A && git commit -m "Release v1.4.0" && git tag v1.4.0 && git push origin main --tags
```
